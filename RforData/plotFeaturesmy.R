...
heat.plot = ggplot2::ggplot(mat.data, ggplot2::aes_string(x = "feature", y = "repl")) +
  ...
  ggplot2::theme_void() +
  ggplot2::labs(y = "Feature subset", x = "Feature", title = "") +
  ...
  ggplot2::theme(axis.ticks = ggplot2::element_blank(),
                 ...
                 legend.title = ggplot2::element_text(size = 14, color = 'black',
                                                      family = 'Arial', face = 'plain'),  # legend 标题  Times
                 legend.text = ggplot2::element_text(size = 10, family = 'Arial'),    # legend 内容
                 axis.title = ggplot2::element_text(size = 14, color = 'black',
                                                    family = 'Arial', face = 'plain'), #横纵标签
                 axis.title.y = ggplot2::element_text(angle = 90),
                 axis.text = ggplot2::element_text(size = 7, family = 'Arial'),
