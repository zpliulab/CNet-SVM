...
%% 邻接矩阵
% adj = importdata('D:\E\博士\R_程序\SVM\Data\RTCGA\adjmatrix_comp_UNG.csv');
...
%% 割点
% vector_hat = importdata('D:\E\博士\R_程序\SVM\Data\RTCGA\cut_vector_UNgene.txt'); 
...
%% 数据输入
% txt = importdata(['D:\E\博士\R_程序\SVM\Data\RTCGA\TCGA_pro_outcome_TN_log_comp_UNtrain.txt']); 
...
%% 预测
format long;
txt1 = importdata(['Data_test/23.txt']);  
test_data = txt1.data;
[k,l] = size(test_data);
...
%% 保存
csvwrite(['theta_hat23.csv'],theta_hat);
csvwrite(['theta23.csv'],theta);
csvwrite(['P_test23.csv'],P_test);
csvwrite(['para23.csv'],para);
