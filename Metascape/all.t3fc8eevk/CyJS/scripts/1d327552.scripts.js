...
angular.module("cyViewerApp", ["ngCookies", "ngResource", "ngSanitize", "ngRoute", "ngAnimate", "ui.bootstrap", "angular-underscore", "colorpicker.module", "angularSpinner"]).config(["$routeProvider", function(a) {
    ...
    var n, o,
        ...
        r = "default";
        // ZHOU use default
        r=(DEFAULT_STYLE_NAME==null)? "default" : DEFAULT_STYLE_NAME;
        // ZHOU
    ...
    a.LAYOUTS = ["preset", "cose", "cola", "circle"], a.networks = {}, a.currentVS = null, a.visualStyles = [], a.visualStyleNames = [], a.networkNames = [], a.currentNetworkData = null, a.browserState = {
        show: !1
    }, a.overlayState = {
        show: !0
    }, a.toolbarState = {
    ...
    a.toggleTableBrowser = function() {
        ...
        c = a.networkNames[0];
        // ZHOU use default
        c=(DEFAULT_NETWORK_NAME==null)? a.networkNames[0] : DEFAULT_NETWORK_NAME;
        // ZHOU
        n = styles;
